...
import { Meteors } from "../ui/meteors"; // Adjust the import path as necessary

export function MeteorCard() {
  return (
    <div className="fixed right-[15%] top-1/2 transform -translate-y-1/2 p-4 w-1/4 h-1/4 scale-[1.7]">
